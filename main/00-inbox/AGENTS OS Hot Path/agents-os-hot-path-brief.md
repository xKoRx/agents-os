...
- Dos flujos casi repetidos en [agents-os.md (line 67)](/Users/rodrigojara/obsidian/SecondBrain/main/80-agents/agents-os/agents-os.md:67).
- Otro procedimiento en [agents-os-bootstrap/SKILL.md (line 86)](/Users/rodrigojara/obsidian/SecondBrain/main/80-agents/skills/agents-os-bootstrap/SKILL.md:86).
...
El conjunto potencial de guía, constitución, perfil, bootstrap, retrieval y memorias `always` pesa aproximadamente 21–24 mil tokens antes de cargar contexto específico. Es unas 7–8 veces el objetivo histórico cercano a 3.000 tokens registrado en el [proyecto controlador (line 480)](/Users/rodrigojara/obsidian/SecondBrain/main/10-projects/AGENTS OS/AGENTS OS.md:480).

También hay una contradicción directa en el Context Router: dice “nunca saltar capas”, pero su tabla comienza relaciones y código directamente en la capa 2. Está en [agents-os-context-retrieval (line 35)](/Users/rodrigojara/obsidian/SecondBrain/main/80-agents/skills/agents-os-context-retrieval/SKILL.md:35).

### 2. El cierre mezcla persistencia interna con UX

El cierre exige un inventario de doce campos —raw, summary, feedback, learnings, ADRs, known errors, runbooks, logs, Graphify, etc.— en [agents-os-session-close (line 137)](/Users/rodrigojara/obsidian/SecondBrain/main/80-agents/skills/agents-os-session-close/SKILL.md:137). Eso explica que el usuario reciba un reporte que no necesita.
...
- Como Graphify se usa casi siempre, también tiende a crear un segundo feedback específico, según [agents-os-session-feedback (line 41)](/Users/rodrigojara/obsidian/SecondBrain/main/80-agents/skills/agents-os-session-feedback/SKILL.md:41).
...
La invalidación ocurre si cambia una fuente base, la entidad activa o la intención. No corresponde releer guía, constitución y bootstrap “cada vez que el usuario hable”, como hoy ordena [AGENTS.md (line 5)](/Users/rodrigojara/obsidian/SecondBrain/main/AGENTS.md:5).
...
Hay además un hallazgo de seguridad P0: una memoria interna de dominio marcada `always` contiene una credencial en texto plano. Viola las reglas de la [constitución (line 83)](/Users/rodrigojara/obsidian/SecondBrain/main/80-agents/agents-os/agent-constitution.md:83) y debe retirarse del vault y rotarse, sin reproducirla.
...
- [AGENTS.md (line 7)](/Users/rodrigojara/obsidian/SecondBrain/main/AGENTS.md:7) apunta a `/Users/rjara/...`, pero el vault está bajo `/Users/rodrigojara/...`.
...
- El proyecto controlador todavía muestra `session-close` como pendiente en [AGENTS OS.md (line 205)](/Users/rodrigojara/obsidian/SecondBrain/main/10-projects/AGENTS OS/AGENTS OS.md:205).
- El snapshot para ChatGPT apunta a una ubicación antigua de constitución en [PROJECT-STATE.md (line 239)](/Users/rodrigojara/obsidian/SecondBrain/main/10-projects/AGENTS OS/chatgpt-pack/PROJECT-STATE.md:239). Las fuentes live principales sí usan correctamente `80-agents/agents-os/agent-constitution.md`.
