...
- Dominios activos al 2026-08-11: `agents/`, `applications/`, `aranea/`, `methodologies/` (con `methodologies/sdd/` como subdominio activo), `rio-atlas/`, `tools/` y `vibe-coding/`. `runbooks/`, `ideas/`, `meetings/` y `sqx/` mantienen su función propia; no se promueven implícitamente.
