...
>
> **Estado de ejecución (al 2026-09-18)**: la nota «NO ejecutado» anterior quedó obsoleta. Ejecutado y verificado: R0 reconciliación (2026-09-16), R1 bootstrap-config (2026-09-17: traefik-config, second-brain, hermes-state BACKUP+RESTORE_VERIFIED en staging Hermes — NO offsite), D0 saneamiento documental, R1.5 config completion (2026-09-17: etcd-snapshot + pve node-local VERIFIED+AUTOMATED, timers activos; pi-hole GATED). **R2 (2026-09-18 tarde): discovery efectivo PBS ejecutado — accesos `ariadna@` demostrados (PBS .123 + 5 nodos), PBS 4.2.6-1 viva y VIRGEN (0 datastores/usuarios/jobs), decisión gate 0.2 = REUTILIZAR, cero mutaciones; Owner Action Bundle pendiente (`~/aranea/work/r2-pbs-20260918/`: datastore LV, credenciales, tickets 018/019).** Roadmap R0–R8: `[[2026-09-16-R0-reconciliacion]]` §9. Lo único ejecutable con evidencia: `BACKUP-DR-RUNBOOK` §0.
