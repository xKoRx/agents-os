...
> [!info] Estado corriente (2026-09-21)
> El bloque "Estado de ejecución" de abajo es un snapshot histórico al 18-20sep. El estado vigente, datado por evidencia, vive en [[ARANEA-CONTINUIDAD-Y-VENTANA-25-26-SEP]] y en la bitácora de [[BACKUP-DR-OWNER-PROJECT]] (G1A/G1B/MP-01 cerrados 20sep; A1 dumps DONE 21sep; R2 3/7; semana 21-25sep de preparación, ventana P0 sáb 26sep pendiente de autorización).
