...
| revalidación read-only H6 (Ceph -s json + pvecm status + pvesm status desde zeus .100: HEALTH_WARN 2 OSD/2 pools nearfull, pool1 87.29%, 129 pgs active+clean, quorum 5/5, aranea-pbs/nfs-storage/pool1 active; estado local R2: timer aranea-r2-measure activo) | 2026-09-19 13:10–13:20 (-03) | probes read-only live; evidencia fuera del vault en `~/aranea/work/h6-integration-20260919/` | **0 días** ✅ | Índice [[30-resources/aranea/07-integration/00-index|integration H6]], [[integrated-orchestration-contract]], matrices vigentes en [[HERMES — Infrastructure Operations]] |
