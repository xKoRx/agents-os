...
- 2026-09-18: certificación funcional 3 consumidores (Cursor resolviendo su `mcp.json` real + `${env:VAR}`/chain kor; ZCode/Codex runtime vía caps-map+chain) — `namespace.list` real contra 1.31.2, `NAMESPACE_NOT_ALLOWED` en temporal-system, mutadores absent, leak clean. Change log `2026-09-18-mcp-trio-functional-certification`.
