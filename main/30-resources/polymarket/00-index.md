...
| [[Polymarket Engine — Five-POC Guía Operativa 2026-09-20]] | Guía operativa de las cinco POCs (S01–S05): HOW TO RUN, input, mode, output, artifacts, research surface, interpretación de contadores y limitaciones; baseline final `feature/five-poc-integration@1bcae43` (HEAD `c915c11`, receipt `certificate-v06`), M4 recert no-live 27/0/0/5. | `status: FIVE_POC_FINAL_ACCEPTANCE_READY (hypothesis_validated=NO)` |
