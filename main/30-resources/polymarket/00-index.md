...
- **Punto de retoma para nuevos agentes:** [[Polymarket Engine — Continuidad Five-POC 2026-09-20]]; leer junto al padre y la guía operativa antes de abrir código. Resume decisiones, SHAs, receipts, tareas con owner y bloqueos. Addendum 2026-09-21: PE-001 reality check `GO_RESEARCH` (§9), hardening `ENGINEERING_STAGE_CLOSED_RESEARCH_REPRODUCIBLE` (§10), dictamen U-02 **`V2_CASH_CONFIRMED`** (§11), S02 E2 **`NO_SIGNALS_IN_SAMPLE`** (§12), consolidación **`MASTER_CANONICAL`** (§13) y semana Sports **`ARMED_WAITING_NEXT_WINDOW`** (§14, `master@bfa6eaf`).
- **Último cierre técnico (2026-09-21):** `ARMED_WAITING_NEXT_WINDOW`. Engine publicado: default `master` = `origin/main` = `bfa6eaf`. Código de fee identities `c3b1aa1`. M4 recertificado no-live **en `c3b1aa1`** (27/0/5 diferidos live). Canary 4584879 PASS. Campaña de 7 días armada, reloj no iniciado. `LIVE_DISABLED`. `d5ce263` no mergeado. Detalle en continuidad §14 y [[2026-09-21-pe005-r1-sports-week]].
...
|---|---|---|
| [[Polymarket Engine — Continuidad Five-POC 2026-09-20]] | Handoff canónico de retoma: semana Sports §14 `ARMED_WAITING_NEXT_WINDOW`, `master@bfa6eaf`, U-02 `V2_CASH_CONFIRMED`, Sports E2. | `status: ARMED_WAITING_NEXT_WINDOW; LIVE_DISABLED` |
| [[Polymarket Engine — Five-POC Guía Operativa 2026-09-20]] | Ejecución de S01–S05. Código publicado `c3b1aa1` / recibo `bfa6eaf`. Campaña T−90 armada. `hypothesis_validated=NO`. | `status: ARMED_WAITING_NEXT_WINDOW; hypothesis_validated=NO` |
...
- **Código vs vault vs remoto:** engine `origin/master` = `origin/main` = `bfa6eaf` (publicado 2026-09-21). Recibo M4 vigente: `testdata/research-master/certificate.json` pineado a `c3b1aa1`. `a770da6` / `85e27ff` y v07 @ `c38f6c4` son históricos.
