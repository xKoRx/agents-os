...
> **Área:** [[Personal]] · **Estado:** archived · **Prioridad:** P1 · **Sprint:** —
...
- **ARCHIVED / SCOPE ABSORBED (2026-09-23).** El código `selection_cohort` ya está integrado a `master`; Campaña B deja de ser un planner independiente. Sus gates de validación física y producto se ejecutan como **C6 — Deep Validation** dentro de [[Echo Forge — Operación Real V2]].
...
- **2026-09-23 — ARCHIVE OWNER.** El owner cambia el modo de trabajo: Campaña B deja de gestionarse como proyecto separado y se certifica con estrategias reales dentro de [[Echo Forge — Operación Real V2]] C6. Historia técnica preservada.
