...
|---|---|---|---|---|---|
| xKoRx/symphony | `feature/sqx-campaign-b` @ `3847cad` (local, sin push) | `master @ 9a69243` | Mandato owner 2026-09-23 + `specs/FEAT-SQX-IMPORT-CAMPAIGN-B/SPEC.md` (§2.1 congelada) | Mismo repo: runtime `selection_cohort`, activity `resolve_selection_cohort`, workflow `runSelectionCohortBootstrap` | **CB-G2 código PASS (regresión = baseline exacto); CB-G1 review + owner §3 pendientes** |
...
> - [ ] CB-G1: SPEC freeze con §2.1 + review manager independiente del delta `dc151e4` + NORMAL de Campaña B #owner/me #type/pr-review
...
> - [ ] Push de `feature/sqx-campaign-b` tras CB-G1 (scan de secretos antes) #owner/me #type/dev
...
- Parent: [[Echo Forge]] · Predecesor: [[Echo Forge — Import Task V1]] · Entorno: [[Echo + Echo Forge — Environment Contract]]
...
- Worktree: `~/aranea/work/campaign-b-20260923/symphony` (rama `feature/sqx-campaign-b`, local sin push)
