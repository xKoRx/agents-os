...
root: false
status: in-progress
status_detail: "R2 CIERRE DEL PILOTO (2026-09-18 noche, mandato owner). Hallazgo etcd RESUELTO: mp0 excluido por DEFAULT de PVE 8.4 (no por flag del CT; familia completa 101/147/148/154/155/156 comparte patrón); datos protegidos por R1 lógico (rev 56625/985 keys, restore offline re-demostrado 18sep); decisión provisional MANTENER exclusión de facto. Seguridad montaje: dir 000 del piloto NO quedó aplicada (755 real); propuesta fail-closed drop-in systemd en bundle v3 Acción 1. Baseline capacidad: 733M/295G, 429 chunks; umbrales 70/85%/30G. Plan 7d definido: 7 CTs local-lvm (155/156/154/101/147/148/115), sin estado persistente, NO activado. Ceph pool1 87.16% nearfull pre-existente → kafka GATED, no afecta set activo. Bundle ÚNICO v3 (3 acciones independientes) ESPERA OK owner. Retención/schedules NO configurados; reboot pendiente ventana. R2 NO certificado."
priority: P2
progress: 0
icon: 🖥️
...
- [ ] **AGENT-TASK-02-8**: aplicar fail-closed del datastore PBS (drop-in systemd; bundle v3 Acción 1) — requiere OK owner.
  - tags: [agent, gated, owner-approval, pbs-config]

- [ ] **AGENT-TASK-02-9**: ejecutar medición 7 días (7 CTs; bundle v3 Acción 2) — requiere OK owner; driver local, cero estado persistente en PVE/PBS; umbrales ABORT definidos.
  - tags: [agent, gated, owner-approval, measurement]

- [ ] **AGENT-TASK-02-10**: reboot controlado PBS en ventana autorizada (bundle v3 Acción 3; valida fstab + drop-in + datastore tras reinicio) — GATED ventana.
  - tags: [agent, gated, maintenance-window]
