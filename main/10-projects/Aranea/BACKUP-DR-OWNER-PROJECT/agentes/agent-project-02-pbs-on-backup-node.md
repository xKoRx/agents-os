...
root: false
status: in-progress
status_detail: "R2 PILOTO EJECUTADO (2026-09-18, mandato owner): datastore main en disco nuevo vm-180-disk-1 300G (fstab UUID nofail + dir 000 anti-mount-vacío), backup@pbs + token con ACL mínima verificada, storage aranea-pbs active 5/5, backup piloto 155 PASS (verify ok), restore estructural CT 990 PASS (sin boot, fixture destruido). HALLAZGO: mp0 etcd excluido por config del CT 155 (datos NO entran al backup) — decisión owner pendiente. Retención/schedules NO configurados; reboot PBS real pendiente de ventana. R2 NO certificado (faltan criterios de 7 días)."
priority: P2
progress: 0
icon: 🖥️
