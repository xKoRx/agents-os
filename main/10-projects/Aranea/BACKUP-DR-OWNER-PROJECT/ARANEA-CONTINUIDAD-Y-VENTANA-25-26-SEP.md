...
- **K2 23sep — condición cerca de disparar**: L1 13:40 osd.0/2 = **88,21/88,22%** (margen ≈0,8pp a ≥89%); sondeo 13:49 88,23/88,25% (Δ9,5 min NO válido para la condición; lectura 2 válida ≥14:40 registrada en [[K2-CEPH-RISK-20260920]]). Al ritmo vespertino (~1,8G/OSD/h) puede disparar esta tarde/noche → escalar owner si se cumple (acción gated `qm shutdown 125`; P1-v3 aborta por §6 de su runbook).
