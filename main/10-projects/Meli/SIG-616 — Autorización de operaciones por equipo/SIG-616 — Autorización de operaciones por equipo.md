...
- **Variantes de test Slice 3:** `feature/sig-616-auth-p3-committer-test3-v17@844e2da344bc` y `feature/sig-616-auth-p3-viewer-test3-v18@19af793b591b` están publicadas; Fury aceptó `0.1.3-p3-committer-allowed` y `0.1.4-p3-viewer-denied`, ambas todavía en estado `CREATING`. La primera mockea `committer` para permitir `DEV_AND_UP`; la segunda mockea `viewer` para denegar antes de side effects.
