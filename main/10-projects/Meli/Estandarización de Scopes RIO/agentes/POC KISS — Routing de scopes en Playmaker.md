...
%% Naming: POC KISS — Routing de scopes en Playmaker es el link canónico del proyecto; aliases guarda variantes humanas; tags/slugs son solo automatización. %%

> [!info]+ POC KISS — Routing de scopes en Playmaker
...
> `- [ ] [[POC KISS — Routing de scopes en Playmaker]] arrancar + seguimiento #owner/me #type/supervision #area/personal`
