...
%% Naming: SIG-610 — ComponentRun de inactivación en Playmaker es el link canónico del proyecto; aliases guarda variantes humanas; tags/slugs son solo automatización. %%

> [!info]+ SIG-610 — ComponentRun de inactivación en Playmaker
...
> `- [ ] [[SIG-610 — ComponentRun de inactivación en Playmaker]] arrancar + seguimiento #owner/me #type/supervision #area/meli`
