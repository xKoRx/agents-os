...
- **Estado del plan:** `phase_2_g2_review`; el owner aceptó G1 el 2026-09-09 y Fase 2 está implementada, pendiente de revisión de G2.
- **Código:** Fases 1 y 2 implementadas, con suite completa verde; history productivo no fue modificado.
...
| G2 | review | Aislar los runs de inactivación con los dos filtros `DEPLOY`, eliminar la consulta muerta, correr regresión/cobertura y entregar | Suite completa verde, cobertura ≥95% líneas/branches en clases F2, status/diff limpios y no-touch respetado | Revisión humana y posterior archivo |
