...
%% Naming: SIG-610 — Seguimiento de inactivación es el link canónico del proyecto; aliases guarda variantes humanas; tags/slugs son solo automatización. %%

> [!info]+ SIG-610 — Seguimiento de inactivación
...
> `- [ ] [[SIG-610 — Seguimiento de inactivación]] arrancar + seguimiento #owner/me #type/supervision #area/meli`
