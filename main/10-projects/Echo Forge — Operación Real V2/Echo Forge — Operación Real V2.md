...
- **Baseline operativo vigente:** el manager previo consolidó Campaña B en `master` y publicó RC 0.2.106. C0 debe revalidar el SHA exacto de master/runtime antes de iniciar la campaña; no asumir un SHA desde esta nota.
