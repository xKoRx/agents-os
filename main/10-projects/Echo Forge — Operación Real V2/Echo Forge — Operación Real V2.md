...
> - [ ] **C2** Auditar personalmente evidencia SQX vs GUI/report y congelar campos confiables #owner/me #type/research #area/echo — BLOCKED (8.ª sesión 2026-09-26): causa raíz corregida — NO fue la GUI: attempt 2 (Hera 25-sep 05:00Z) corrió el sqcli completo y falló `persist_import_evidence: overview scope instrument "NDX": contract_conflict` (CanonicalSymbol sin NDX, fail-closed) ⇒ 0 evidencia. Desbloqueo propuesto: alias `ndx→usatechidxusd` (R7) + re-despacho técnico wave1c. FlowRun `1a4d66d6` wedged (no re-ejecutable). Datos históricos flota EQUAL post-sync 2026-09-26 (`07f1f285…`)
