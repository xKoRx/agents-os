...
- [/] SPEC-03-A Knowledge Baseline: Evidence → reconstruction → integrity → grounding → consolidation → JSONL → Markdown, sin investigator; determinismo por replay. #owner/agent #type/dev #area/personal
