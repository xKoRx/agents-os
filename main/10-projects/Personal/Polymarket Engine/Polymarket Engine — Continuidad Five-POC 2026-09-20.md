...
| Datos/hipótesis | Fixtures sintéticos; datasets RS v0.3 (41/41 SHA OK) y pe001 (78/78 SHA OK) intactos; Weather/Catalog **inventariados** 2026-09-21 sin vintages ni cohorte nueva; fee venue `U02_PARTIAL` (`REAL_FEE_READY=NO`); `HYPOTHESIS_VALIDATED=NO` en las cinco. Etapa: `ENGINEERING_STAGE_CLOSED_RESEARCH_REPRODUCIBLE`. |
