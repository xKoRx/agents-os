...
- [ ] FASE C: canal canónico Catalog→estrategias + `Universe→SCREEN→REPLAY→SHADOW→Scorecard` por POC sobre journal real apto #owner/me #type/dev #area/personal
- [ ] Quality completo + gates afectados + certificado sobre SHA final con harness existente; `LIVE_DISABLED` intacto; checkpoint final limpio #owner/me #type/dev #area/personal
