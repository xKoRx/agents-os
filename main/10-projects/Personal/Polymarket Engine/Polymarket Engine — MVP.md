...
- [/] NORMAL: implementar Engine MVP — **S01 Foundation DONE (2026-09-17):** repo `~/go/src/github.com/xKoRx/polymarket-engine`; foundation contracts v1, config estricta, archtest, `cmd/engine version`; build/vet/test/race verdes; coverage 95.1%; G-01 PASS (porción S01, 62 vectores) + G-15b base mecánica PASS con evidencia física en `testdata/foundation/evidence/`; G-02/G-03+ NOT_RUN; siguiente S02 ∥ S03 (barrera M2.2) #owner/me #type/dev #area/personal
- [ ] NORMAL: M2-S02 Protocolo wire ∥ M2-S03 Capture+Persist #owner/me #type/dev #area/personal
