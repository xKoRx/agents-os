...
- [ ] NORMAL: M2-S04 Catalog/Universe + Gamma read-only — **habilitado por barrera M2-BARRIER-A (2026-09-17):** M3-A cerrado (S01–S03); insumos listos (DTOs/parsers Gamma, framework capture/persist, `reducer_cursors`, banda de migraciones 0010–0019, subcomandos `catalog sync|inspect`) #owner/me #type/dev #area/personal
