...
- **2026-09-08 (NORMAL — cierre de findings bloqueado):** requested keys usa la receta D("echo-metric-keys.v1", sorted_keys) con golden independiente; la gramática de metric keys es específica y se aplica en MetricV1, MetricSetV1, RequestedKeysDigest y MetricSelector; ScopeV1, EvaluationV1, TradingFactV1 y HandoffManifestV1 exigen capabilities ordenadas y únicas sin mutar al caller; NormalizedOperation exige record_digest, lo recomputa y verifica, y valida supersession refs presentes. go vet y gofmt PASS; go test y race/cover fallan sólo en G28/G30/G32 por fixtures NDJSON sin record_digest. No se creó commit ni se hizo push por el bloqueo; VERIFICATION.md intacta.
