...
- **BLOCKED_BY_S0_ERRATUM → RESOLVED IN ERRATUM BRANCH (2026-09-13).** V3-006 ya no queda bloqueado para la autoridad canónica: `fix/s0-metric-formula-identity-erratum` @ `5751940e7a8ce92d94d8d8a4f14ecedc2890681d` implementa la corrección S0 y queda pendiente de Independent Verifier; E-05 no modificó source ni cambia su estado a VERIFIED.
