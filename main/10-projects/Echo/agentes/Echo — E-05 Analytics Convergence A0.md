...
- **BLOCKED_BY_S0_ERRATUM → RESOLVED IN ERRATUM BRANCH (2026-09-13).** V3-006 ya no queda bloqueado para la autoridad canónica: `fix/s0-metric-formula-identity-erratum` @ `8a979fb5bf218abed5f5c352896b727303dbf65f` implementa la corrección S0 y queda pendiente de Independent Verifier; E-05 no modificó source ni cambia su estado a VERIFIED.
