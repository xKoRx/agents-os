...
- **F-01 CLOSED. F-02 CLOSED. F-03 CLOSED. F-04 C4 CONTRACT CLOSED (2026-09-13) — READY FOR NORMAL C4 sobre `d645ed6`; T2.11–T2.13 OPEN.** PHYSICAL 0.2.97 reveló parse de CanonicalStrategyID; F-01 no se reabre. E-04 join sigue one-shot separado. F-05 pendiente.
...
- **ID / status / size:** F-04 · WIP (C4 READY FOR NORMAL) · LARGE (pipeline único; milestones internos allocation→stamp→seal→adapter; no F-04A/F-04B)
...
- **Status:** WIP. C4 CONTRACT CLOSED 2026-09-13 — READY FOR NORMAL. SPEC [[Echo Forge — F-04 Magic Allocation, Version Seal and Handoff Contract]]. Hijo [[Echo Forge — F-04 Magic allocation, version seal and handoff]]. T2.11–T2.13 OPEN. Migration 015/016; C4 migration NONE.
...
- **2026-09-13** — TOP F-04 C4 CONTRACT CLOSED: Magic V1 no parsea CanonicalStrategyID; instrument/direction = `sqx.strategies`; TaskSpec `magic_number` no es requested. NORMAL C4 pendiente. Tarea puente F-04 `[r]→[/]`. T2.13 E-04 runtime queda one-shot separado.
