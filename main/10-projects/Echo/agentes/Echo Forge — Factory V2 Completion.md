...
- **F-01 CLOSED. F-02 CLOSED. F-03 CLOSED. F-04 C5.1–C5.6 IMPLEMENTED (2026-09-12) @ `b57bfb2` — release `0.2.98` publicada desde el SHA certificado el 2026-09-13, pero rollout bloqueado por environment: Zeus/Hera/Kronos no materializaron `0.2.98` y siguen en `0.2.40` por symlink/PENDING; T2.11–T2.13 OPEN; not physical-ready and F-04 not closed.** Manifest identity must not parse CanonicalStrategyID. E-04 join sigue one-shot separado. F-05 pendiente.
