...
- **F-01 CLOSED. F-02 CLOSED. F-03 CLOSED. F-04 C5.1–C5.6 IMPLEMENTED (2026-09-12) @ `b57bfb2` — READY FOR MANAGER REVIEW; C4.1–C4.6 CLOSED @ `bba833d`; T2.11–T2.13 OPEN; not physical-ready and F-04 not closed.** Manifest identity must not parse CanonicalStrategyID. E-04 join sigue one-shot separado. F-05 pendiente.
