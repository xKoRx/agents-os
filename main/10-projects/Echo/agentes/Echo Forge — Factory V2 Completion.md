...
- **F-01 CLOSED. F-02 CLOSED. F-03 CLOSED. F-04 C5.1–C5.6 IMPLEMENTED (2026-09-12) @ `b57bfb2` — release `0.2.98` publicado desde el SHA certificado el 2026-09-13, pero rollout/runtime INCONCLUSIVE por ausencia de MCP SSH/runtime; T2.11–T2.13 OPEN; not physical-ready and F-04 not closed.** Manifest identity must not parse CanonicalStrategyID. E-04 join sigue one-shot separado. F-05 pendiente.
...
- **2026-09-13** — F-04 one-shot físico: baseline y pre-release PASS; release `0.2.98` publicado por el deployer canónico desde `b57bfb2c...`; rollout no certificable sin capability MCP SSH/runtime, por lo que no se ejecutó el flow ni se creó golden. T2.11/T2.12/T2.13 permanecen OPEN; F-04 sigue no cerrado.
