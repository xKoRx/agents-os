...
- **UBICACIÓN DE CÓDIGO (2026-09-21):** `4aad647b` está integrado en `origin/feature/e09-execution-copy-reconciliation-fidelity` @ `865532078f2c1993e7a3a542a78a9db0fad1f015` (merge `5e0017e5`). La ref remota `feature/e04-dev-ingest-recovery` fue retirada. El worktree de recovery quedó en `4aad647b`. El Gateway DEV sigue en el binario `3d260e81`; esta consolidación no redesplegó. T21 DEV ya certificado no se reabre ni se vuelve a marcar aquí.
- **GIT RECOVERY PUBLISHED — `E04_RECOVERY_PUBLISHED` (2026-09-21T13:0xZ, TOP manager R1).** `origin/feature/e04-dev-ingest-recovery` = `4aad647b` (FF desde `2360369c`, read-back OK; master intacto `5dd998f1`). Commits certificados `2498042f`+`3d260e81` recuperados intactos y publicados; en cima: `988e0ae6` (bypass ETCD dump→production cerrado, guardas v1/v2) y `4aad647b` (migración 064→**068** por colisión con `064_reference_enrollment_binding` de E-06; DAG 065/066/067 ocupado). Gateway DEV sigue ejecutando `3d260e81` (2º commit de la branch; sin redeploy); Core `5dd998f1` intacto. Delta review PASS (S0 diff 0; suites PG descartable PASS); golden examinado: `PERSISTED_JSONB_CANONICAL_REENCODE_VERIFIED` (no transport-bytes). Detalle: [[Echo + Echo Forge — Deferred Certification Backlog]] delta 2026-09-21T13:0xZ.
...
- **CONTROLLED INTEGRATION COMPLETE — E-04 INTEGRATED = YES (2026-09-12).** Fetch/race check PASS: base `origin/master`=`fac4805185eb586bb73c3df0c0ccc20d1377099c`, feature=`2f8db34560e9804c24287ecad9bdd5c8d3d41d03`; master fue ancestro de la feature. Gates mínimos pre-merge PASS en PG 17.5 descartable, en serie: identity_bwc 061, E-03 34, E-04 SDK/gateway `-race`, SOURCE/contracts/migrations y S0 contracts. Integración ejecutada con `git merge --ff-only 2f8db345`; push normal posterior verificado: `origin/master` final=`a99f9a63354bbe72219d1e590bb93757ed08e45e`, feature intacta=`2f8db34560e9804c24287ecad9bdd5c8d3d41d03`, ancestry PASS. Sin reescritura, merge commit ni force-push. **READY_FOR_INTEGRATION = CONSUMED.** **T21/AC-37 = PENDING POST-INTEGRATION** por `FORGE_GOLDEN_FIXTURE_PENDING`; **E-04 FINAL CLOSED = NO**. No se inventó golden y F-04 no fue tocado. Evidencia: `specs/FEAT-FORGE-INGESTION-E1/VERIFICATION.md`, sección CONTROLLED INTEGRATION.
- **Development continuity decision (2026-09-13):** E-04 T01–T20 permanece `IMPLEMENTED / SOURCE VERIFIED / INTEGRATED`; la ausencia de golden físico no bloquea desarrollo posterior que no dependa semánticamente de T21. T21/AC-37 sigue `HARD BLOCKED / DEFERRED`, no waived, hasta [[Echo + Echo Forge — Deferred Certification Backlog]] CERT-E04-01 y CERT-F04-03.
