...
|---|---|---|---|---|---|
| xKoRx/echo | `feature/e06-reference-enrollment-binding` | `5dd998f16aea7b2821f460188718d7a6d279829c` | [[Echo — Forge Ingestion, Runtime Identity and Live Authority Contract V1]] §§5–6; O1/O3 Fable; C-3 collector + excepción Manager §7.2a | `specs/FEAT-REFERENCE-ENROLLMENT-BINDING-E6/SPEC.md` v1.2.2 (encoding v1 + erratum liveness refresh; HEAD `acf996ad`, contrato `28afc47f`; previo `336c723b`) | E06_WPA_READY_FOR_MANAGER_REVIEW @ `429e5c03` (T01–T03 PG REAL PASS; T04–T22 pendientes) |
