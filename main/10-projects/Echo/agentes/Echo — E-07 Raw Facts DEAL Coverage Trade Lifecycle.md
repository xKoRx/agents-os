...
|---|---|---|---|---|---|
| xKoRx/echo | `feature/e07-raw-facts-deal-lifecycle` | `b66dc5ff` (E-06 HEAD; master `5dd998f1` intacto) | `specs/FEAT-RAW-FACTS-DEAL-COVERAGE-LIFECYCLE-E7/SPEC.md` v1.0.0 + ERRATUM-A §17 @ `28213bbc` | `.../PLAN.md` + `.../TASKS.md` + `.../VERIFICATION.md` (§1–§7 NORMAL + §8 C1 + §9 C2) | E07_IMPLEMENTATION_COMPLETE v1.0.0 + C2 consumido · CONTRACT/PG PASS · PHYSICAL_PENDING · FINAL_CLOSED=NO |
