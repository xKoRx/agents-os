...
- **E-06 PLANNING BLOCKED — MANAGER DECISION REQUIRED (2026-09-16):** [[Echo — E-06 Reference Enrollment and Binding]] SPEC v1.1.0 **CASE C** (zero-order magic). Live Authority §5 vs Fable C-3 no cierran A vs B. Docs-only; 0 product source. AutoTrading B2 intacto. C-3 DEFER intacto. NORMAL no lanzado. HEAD `349b6ac8` (old `3e190d86`). E-01…E-05 no reabiertos.
