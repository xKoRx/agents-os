...
- **E-08 PLANNING FROZEN v1.0.0 (2026-09-20):** [[Echo — E-08 Routing EconomicCommand and Risk Reservation]] SPEC/PLAN/TASKS/VERIFICATION + NORMAL-PROMPT @ `fe5c9de0` en branch `feature/e08-routing-economic-command-risk-reservation` (base `3765f2ba` = HEAD E-07 C3; master `5dd998f1` intacto). Migración 066 reservada (exclusiva E-08). Gate RAW-BEFORE-ROUTE elevado a boundary estructural RG-1…RG-6 (sólo hechos `PROCESSED` commiteados + pin OBSERVING válido; PublishSync ≠ commit durable; UNKNOWN/SHADOW jamás elegibilidad; replay jamás genera segundo comando; dispatch jamás adelanta al commit). CommandID determinístico por `command_unique_key`+`content_digest` con UUIDv7 mint-once (consume defer E-02 §1.0.1). Snapshots inmutables content-addressed; reservas integradas al command con headroom serializado por cuenta y `UNKNOWN_HELD` sin auto-release; outbox monotónico en la fila del comando; recovery sin resend ciego; reconciliación como superficie E-09. Separación frozen: clase A (persistencia/identidad, PG con cero órdenes) vs clase C (activación económica condicionada: prerrequisitos E-07 PHYSICAL, E-06 G1/T21, MQL_COMPILE, corrección `EchoPersistence.mqh`, E-02 AC-18). Next = NORMAL.
