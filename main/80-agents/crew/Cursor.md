...
- Registrar el identificador exacto del modelo seleccionado en Cursor; no mezclarlo con el nombre del modo o agente.

## 🛠️ Limitaciones Técnicas y Operativas

- La selección de modelo es dinámica y puede variar por agente o tarea; el perfil no declara un modelo base.
