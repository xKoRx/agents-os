...
- Registrar el identificador exacto del modelo expuesto por Codex; no inferirlo desde capacidades o fecha.

## 🛠️ Limitaciones Técnicas y Operativas

- La selección de modelo es dinámica y puede variar entre tareas o subagentes; el perfil no declara un modelo base.
