...
- **`delete_topic` Kafka eventual (MEDIUM):** la respuesta de éxito no garantiza eliminación; el residual del smoke 2026-09-13 sobrevivió >1 día y el delete de esta run requirió retry. Las certificaciones que usan topics efímeros necesitan post-condición de ausencia, no el exit del delete.
