...
| [[80-agents/skills/signals-code-review/SKILL.md|signals-code-review]] | Revisa branches y PRs exclusivamente Meli con Zord; en Signals/RIO agrega el revisor independiente `rjara-rio-impact`, specs, descripción del PR y fuentes oficiales. | Al hacer code review Meli. Fuera de Meli termina sin ejecutar Zord; ejecución mecánica en [[signals-code-review-runbook]]. |
...
|---|---|---|
| `xKoRx/symphony` → `.agents/skills/aranea-mcps-expert/SKILL.md` | Selecciona y gobierna capabilities MCP exclusivas del homelab Aranea; obliga autoridad mínima y delega detalles a runbooks SSH/PostgreSQL/MongoDB. | ✅ fuente canónica app-owned; **MUST NOT** usarse para MELI/corporativo |
