...
- Corrección duradera pendiente: separar cada tool en su propio subdirectorio/comando o aplicar build tags válidos, y hacer que la generación de artifacts use rutas temporales salvo un comando explícito de actualización.
